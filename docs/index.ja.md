...
[Unitree G1ヒューマノイド](https://www.unitree.com/g1)に取り付けられるよう設計されています。

開発キットを受け取った方は、[実行ページ](getting-started/deployment.md)に進んでください。
そうでない場合は、インストールガイドに従ってください。

機構的な詳細(3Dプリント手順、配線図、組み立てガイド)はハードウェアセクションに、
ソフトウェアの詳細はソフトウェアページに記載されています。
